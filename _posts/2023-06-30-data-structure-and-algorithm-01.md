...
问：试写出用**单链表**表示的字符串类及字符串节点类的定义，并依次实现它的构造函数、以及计算串的长度、串赋值、判断两串相等、求子串、两串连接、求子串在串中位置等7个成员函数
...
1) 棋盘 二维数组=> （稀疏数组 => 压缩）=> 写入文件 【存档功能】

2) 读取文件-》稀疏数组-》二维数组 -》 棋盘 【接上局】

### 2.3 约瑟夫(Josephu)问题（丢手帕问题）
