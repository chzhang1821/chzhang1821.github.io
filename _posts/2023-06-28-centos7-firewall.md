...
1. 手动启动/停止/重启 `firewalld.service` 服务
```shell
# 启动 firewalld
...
1.  任何修改操作，配置完成后，需要重新装在 firewall。可重新启动 firewalld 服务
```shell
firewall-cmd --reload
service firewalld restart
```
